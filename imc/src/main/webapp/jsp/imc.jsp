...
<body>
			...
			<form>
				<div class="row">
					<div class="input-field col">
						...
						<input id="peso" type="number" class="validate blue-text" min="0"
							max="350"> <label class="blue-text" for="peso">Peso</label>
					</div>
					<br>
					<br>
					<div class="input-field col">
						...
						<input id="altura" type="number" step="0.01" min="0" max="350"
							class="validate blue-text"> <label class="blue-text"
	...
	<div class="center">
		<a href="#" id="calcular"
			...
			onclick="imprimirIMC()">Calcular</a> &nbsp &nbsp &nbsp &nbsp &nbsp
		&nbsp &nbsp &nbsp &nbsp <a href="#" id="limpar"
			class="btn-large waves-effect waves-light blue" onclick="limpar()">Limpar</a>
	</div>
	<br>
	<br>
	<br>
			...
			<div class="container">
				<div class="row">
					<div class="col l6 s12">
						...
						<p class="grey-text text-lighten-4">Protótipo semi-funcional
